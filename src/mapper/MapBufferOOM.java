...
public class MapBufferOOM extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		// Parameter:
		// /syntheticData/brownTables/samples/RankingsFiltered/{part-m-0001*}  /syntheticData/brownTables/samples/RankingsFiltered2/{part-m-0001*}  /user/xulijie/output/MapBufferOOM
		...
		conf.set(
		 ...
		 "-Xmx512m -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps");
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new MapBufferOOM(), args);
