...
public class ReducePhaseOOM extends Configured implements Tool {
	...
	conf.setFloat("mapred.job.reduce.input.buffer.percent", 0.2f);
		...
		//conf.set("heapdump.reduce.input.records", "1068023;2136045;3204067;4272089;5340115;5933303;6364863");
		// 18, 13
		//conf.set("heapdump.reduce.input.records", "6364863");
		conf.set("heapdump.task.attempt.ids", "attempt_201404152256_0012_r_000000_0");
		
		conf.set("omit.reduce.input.records", "0;6364863");
		conf.set("heapdump.reduce.input.records", "6364864");
